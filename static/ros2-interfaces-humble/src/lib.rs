...
#[cfg(feature = "ouster_msgs")]
pub mod ouster_msgs;

#[cfg(feature = "turtlebot4_msgs")]
pub mod turtlebot4_msgs;

#[cfg(feature = "robot_controllers_msgs")]
pub mod robot_controllers_msgs;
...
pub mod qb_softhand_industry_msgs;
...
pub mod rosbag2_storage_mcap_testdata;
...
pub mod qb_softhand_industry_srvs;
...
pub mod kuka_driver_interfaces;
...
#[cfg(feature = "hri_actions_msgs")]
pub mod hri_actions_msgs;
...
pub mod off_highway_general_purpose_radar_msgs;
...
pub mod stubborn_buddies_msgs;

#[cfg(feature = "puma_motor_msgs")]
pub mod puma_motor_msgs;
...
pub mod off_highway_premium_radar_sample_msgs;
...
#[cfg(feature = "wrapyfi_ros2_interfaces")]
pub mod wrapyfi_ros2_interfaces;
...
#[cfg(feature = "mocap4r2_msgs")]
pub mod mocap4r2_msgs;
...
pub mod clearpath_platform_msgs;
...
pub mod weight_scale_interfaces;
